...
public class App {
    public static void main(String[] args) throws BestResultNotFoundException {
        ...
        // продукты для поиска
        ArrayList<Searchable> allProductsList = new ArrayList<>();
        allProductsList.add(pear);
        allProductsList.add(grape);
        allProductsList.add(mango);
        ...
        allProductsList.add(article);
        allProductsList.add(article1);
